...
function updateAgent(req, res, next) {
  ...
  db.none('update agents set agent_name=$2, endpoint_enabled=$3, endpoint_url=$4, basic_auth_username=$5, basic_auth_password=$6, rasa_core_enabled=$7, combined_to=$8, default_text=$9 where agent_id=$1',
    [parseInt(req.params.agent_id), req.body.agent_name, req.body.endpoint_enabled, req.body.endpoint_url, req.body.basic_auth_username, req.body.basic_auth_password, req.body.rasa_core_enabled, req.body.combined_to, req.body.default_text])
    .then(function () {
      res.status(200)
        .json({
          status: 'success',
