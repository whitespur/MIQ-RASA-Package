...
var components = ['navigation','accounts', 'avgNluResponseTimesLast30Days', 'rasa/parse', 'rasa/config', 'rasa/status', 'activeUserCountLast30Days', 'agentsByIntentConfidencePct', 'intentsMostUsed','avgUserResponseTimesLast30Days'];
