...
var app =angular.module('app', ['AccountsController','ngCookies','btford.socket-io','ng-jsyaml','ngSanitize','ngFileUpload', 'angularUtils.directives.dirPagination','ngRoute', 'chart.js', 'ngResource', 'ngStorage', 'ngTagsInput', 'jsonFormatter'])
